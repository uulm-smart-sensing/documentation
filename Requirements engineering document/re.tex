...
To add a new feature, it is important to understand the user story process from the perspective of the user. User stories are a proven method to describe requirements from the user’s perspective.
