...
The IOManager is implemented using the Singleton pattern. The reason for this is that sensor data should be controlled by only one component, and not multiple, to prevent multiple access to data streams. There is always only one IOManager present in the Smart Sensing Library, it controls all data operations related to sensor data.
\begin{figure}[ht]
\centering
\includegraphics[width=.9\textwidth]{Graphics/IOManager.png}
\caption{\label{fig:bild5} IO Manager Class Diagramm}
\end{figure}
\newpage
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.3\textwidth]{Graphics/BufferManager.png}
\caption{\label{fig:bild6} Buffer Manager}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.4\textwidth]{Graphics/FilterTools.png}
\caption{\label{fig:bild7} Filter Tools}
\end{figure}
\subsection{SensorManager}
\subsubsection{Preprocessor}
\begin{figure}[ht]
\includegraphics[width=1\textwidth]{Graphics/Preprocessor.png}
\caption{\label{fig:bild8} Preprocessor}
\end{figure}
\newpage
\section{Processes}
...
\caption{\label{fig:bild8} Starting sequence diagram}
\end{figure}
\subsection{Getting Data via a filter}
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\textwidth]{Graphics/SeqFilter.png}
\caption{\label{fig:bild9} Filtering sequence diagram}
\end{figure}
\end{document}